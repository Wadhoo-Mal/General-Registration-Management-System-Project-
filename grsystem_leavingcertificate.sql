...
CREATE TABLE `leavingcertificate` (
  ...
  `gr_no` int DEFAULT NULL,
  `issue_date` date DEFAULT NULL,
  `reason` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`certificate_id`),
  KEY `gr_no` (`gr_no`),
  CONSTRAINT `leavingcertificate_ibfk_1` FOREIGN KEY (`gr_no`) REFERENCES `students` (`gr_no`)
...
INSERT INTO `leavingcertificate` VALUES (7,11,'2026-05-09','Completed his studies.'),(8,12,'2026-05-10','Completed the School.'),(9,13,'2026-05-10','Failure');
...
-- Dump completed on 2026-05-10 13:51:54
